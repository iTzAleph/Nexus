...
module.exports = (client, message, args) => {
    let embed = new Discord.MessageEmbed()
        ...
        .addField(`**${client.config.version}**`, " ¡Hola! yo soy Nexus Canary, la vercion beta de Nexus, estoy aqui para ayudarte a pasar un buen rato en este servidor. A continuacion tienes todos los comandos que puedes utilizar conmigo.")
